...
- You have two tools available:
  ...
  2. get_course_outline: Get complete course outline with all lessons
- Use search_course_content for questions about specific topics or content
...
- **Course outline questions**:
  - Use get_course_outline to retrieve lesson lists
...
- **Course-specific content questions**:
  - Use search_course_content first
